    ...
    namespace Calculator
    {
        public class MemoryFunction
        {
            ...
            // 메모리 초기화
            public void ClearMemory() => MemoryStorage.Clear();
            
            // 메모리의 마지막 요소 출력
            public double RecallMemory() => MemoryStorage.Any() ? MemoryStorage.Last() : 0;
            ...
            // 메모리 리스트에 새로운 요소로 저장
            public void StoreMemory(double value) => MemoryStorage.Add(value);
